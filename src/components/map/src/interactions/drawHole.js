 ...
 */
var DrawHoleInteraction = function (options) {
  if (!options) options = {};
  ...
  if (geomFn) {
    geometryFn = (c, g) => {
      g = this._geometryFn(c, g);
      return geomFn(c, g);
    };
  } else {
    geometryFn = (c, g) => { return this._geometryFn(c, g); };
  }
...
ol.inherits(DrawHoleInteraction, ol.interaction.Draw);
 ...
 * @api stable
 */
DrawHoleInteraction.prototype.setMap = function (map) {
 ...
 * @api stable
 */
DrawHoleInteraction.prototype.setActive = function (b) {
 ...
 */
DrawHoleInteraction.prototype.removeLastPoint = function () {
 ...
 * @return {ol.Feature}
 */
DrawHoleInteraction.prototype.getPolygon = function () {
 ...
 * @private
 */
DrawHoleInteraction.prototype._startDrawing = function (e) {
  var map = this.getMap();
 ...
 * @private
 */
DrawHoleInteraction.prototype._finishDrawing = function (e) {
  var c = e.feature.getGeometry().getCoordinates()[0];
  if (c.length > 3) {
    this.getPolygon().getGeometry().appendLinearRing(new ol.geom.LinearRing(c));
  }
  this._feature = null;
  this._select.getFeatures().clear();
};
 ...
 * @private
 */
DrawHoleInteraction.prototype._geometryFn = function (coordinates, geometry) {
...
export default DrawHoleInteraction;
