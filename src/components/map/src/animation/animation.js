 ...
 * Use the {@link _ol.Map_#animateFeature} or {@link _ol.layer.Vector_#animateFeature} to animate a feature
 ...
 * @param {ol.easing_Function} options.fade an easing function used to fade in the feature, default none
 * @param {ol.easing_Function} options.easing an easing function for the animation, default ol.easing.linear
 */
var featureAnimation = function (options = {}) {
...
ol.inherits(featureAnimation, ol.Object);
...
* @private
*/
featureAnimation.prototype.drawGeom_ = function (e, geom, shadow) {
  if (this.fade_) {
 ...
 */
featureAnimation.prototype.animate = function (e) {
  return false;
};
...
ol.layer.Vector.prototype.animateFeature = function (feature, fanim) {
  ...
  function stop (options) {
    ol.bservable.unByKey(listenerKey);
    listenerKey = null;
